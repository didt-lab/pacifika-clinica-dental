            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                <img
                  ...
                  alt="Endoposte estético y metálico"
                  className="w-full h-44 object-cover"
                  loading="lazy"
                />
                <div className="p-6">
              ...
              >
                <img
                  src="https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?w=600&h=300&fit=crop"
                  alt="Retratamientos de endodoncia"
                  className="w-full h-44 object-cover"
                  loading="lazy"
                />
                <div className="p-6">
              ...
              >
                <img
                  src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=600&h=300&fit=crop"
                  alt="Retiro de corona dental"
                  className="w-full h-44 object-cover"
                  loading="lazy"
                />
                <div className="p-6">
        ...
        <section className="py-20 bg-gray-50">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-5 gap-12">
              <ContactInfo />
              <ContactForm defaultTratamiento="Endodoncia" />
            </div>
          </div>
        </section>
