              ...
              <div className="grid lg:grid-cols-5 gap-0">
                ...
                >
                  <img
                    ...
                    alt="Dr. Juan Manuel Lizárraga - Periodoncista en Mazatlán"
          ...
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-5 gap-12">
              ...
              <div className="lg:col-span-3 p-6 rounded-[15px] flex flex-col" style={{backgroundColor: '#FBFCF5'}}>
                <div className="mb-6">
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Solicitar Cita para Periodoncia</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="Tratamiento de Gingivitis">Tratamiento de Gingivitis</option>
                        <option value="Tratamiento de Periodontitis">Tratamiento de Periodontitis</option>
                        <option value="Cirugía Periodontal">Cirugía Periodontal</option>
                        <option value="Mantenimiento Periodontal">Mantenimiento Periodontal</option>
                        <option value="Injerto de Encía">Injerto de Encía</option>
