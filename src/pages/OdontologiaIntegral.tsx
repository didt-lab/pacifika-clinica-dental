        ...
        <section id="portada_odontologia_integral" className="relative text-white py-20 overflow-hidden">
          ...
          >
            <div
              ...
              style={{
                backgroundImage: 'url(https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?w=1920&q=80)',
              }}
            />
                  ...
                  <div className="space-y-8">
                    ...
                    >
                      <p className="text-lg text-gray-600 leading-relaxed">
                        La <b>Dra. Krizia Zamudio</b> nuestra odontóloga integral, dedicada a la prevención, diagnóstico y tratamiento de problemas de salud bucal. Su enfoque se centra en ofrecer un cuidado completo y personalizado para mantener tu sonrisa sana y radiante.
                      </p>
                    </motion.div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* Card 1 - Limpieza dental profesional */}
              <motion.div
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2 text-center">
                  Prótesis fija (zirconia)
                </h3>
              </motion.div>

              {/* Card 3 - Prótesis removible */}
              <motion.div
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.3 }}
              ...
              {/* Card 4 - Obturaciones y resinas (empastes) */}
              <motion.div
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  answer: "Contáctanos de inmediato. Atendemos emergencias como dolor agudo, dientes fracturados o abscesos para aliviar tu malestar lo antes posible."
                },
                {
