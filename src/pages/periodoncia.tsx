      ...
      <main>
            ...
            <div className="flex items-center">
              ...
              >
                <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6">
                  Periodoncia en Mazatlán: <span className="text-primary-500">Tratamientos para cuidar tus encías y dientes
                  </span>
                </h1>
                <p className="text-xl mb-8 leading-relaxed text-gray-300">
                Especialista en salud periodontal. Tratamientos modernos como <b>limpieza profunda, raspado y alisado radicular, gingivectomías</b>, recubrimientos radiculares, implantes dentales y regeneración ósea.                </p>
                ...
                >
                  <div className="space-y-8">
                    ...
                    >
                      ...
                      El <b>Dr. Mario Cristerna</b> es especialista en <b>Periodoncia</b> con 14 años de experiencia clínica. <b>Egresado de la Universidad Autónoma de Sinaloa (UAS) y con especialidad en la Universidad Quetzalcóatl de Irapuato</b>, cuenta con certificación vigente ante el Colegio Mexicano de Periodoncia (CMP) y es miembro activo de la Asociación Mexicana de Periodoncia (AMP). Su práctica se centra en el diagnóstico y tratamiento integral de enfermedades de las encías, <b>limpieza profunda, cirugías periodontales, recubrimientos radiculares, regeneración ósea e implantes dentales</b>, ofreciendo atención personalizada y de alto nivel profesional.
                      </p>
                    </motion.div>
                    ...
                    >
                      ...
                      >
                        ...
                        Agendar cita con el Dr. Cristerna
                      </a>
                    </motion.div>
                  </div>
                </motion.div>
        ...
        <section className="py-16 bg-white">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">¿Qué es la periodoncia y por qué es importante?</h2>
            <p className="text-lg text-gray-700 leading-relaxed">
              La periodoncia es la especialidad que diagnostica y trata las enfermedades de las encías y los tejidos que sostienen los dientes. Si notas que tus <b>encías sangran al cepillarte</b> o que se ven retraídas, es posible que tengas una <b>enfermedad periodontal</b> en etapa inicial. Detectarla a tiempo permite detener el daño, <b>evitar la pérdida dental</b> y mantener una sonrisa sana y funcional.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-gray-50">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Tratamientos de periodoncia disponibles</h2>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {/* Consulta periodontal */}
              <motion.article
                id="consulta_periodontal"
              ...
              >
                <img src="/imagenes/consulta_periodontal.webp" alt="Consulta periodontal" className="w-full h-44 object-cover" />
                <div className="p-6">
                  ...
                  <a href="https://wa.me/526699928700?text=Hola%2C%20quiero%20agendar%20valoraci%C3%B3n%20periodontal" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-lg bg-primary-500 text-white hover:bg-primary-600 font-medium transition-all">Agendar valoración</a>
                </div>
              </motion.article>
              ...
              <motion.article
                ...
                className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow"
              >
                <img src="/imagenes/limpieza_profunda.webp" alt="Limpieza profunda dental" className="w-full h-44 object-cover" />
                <div className="p-6">
                  ...
                  <a href="https://wa.me/526699928700?text=Hola%2C%20quiero%20agendar%20valoraci%C3%B3n%20para%20limpieza%20profunda" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-lg bg-primary-500 text-white hover:bg-primary-600 font-medium transition-all">Agendar valoración</a>
                </div>
              </motion.article>
              ...
              <motion.article
                ...
                className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow"
              >
                <img src="/imagenes/gingivectomia.webp" alt="Gingivectomía" className="w-full h-44 object-cover" />
                <div className="p-6">
              ...
              <motion.article
                ...
                className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow"
              >
                <img src="/imagenes/recubrimiento_radicular.webp" alt="Cirugía de recubrimiento radicular (Injerto de encía)" className="w-full h-44 object-cover" />
                <div className="p-6">
              ...
              <motion.article
                ...
                className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow"
              >
                <img src="/imagenes/implantes_dentales.webp" alt="Implantes dentales" className="w-full h-44 object-cover" />
                <div className="p-6">
              ...
              <motion.article
                ...
                className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow"
              >
                <img src="https://picsum.photos/seed/regeneracion-osea/600/300" alt="Cirugía de regeneración ósea" className="w-full h-44 object-cover" />
                <div className="p-6">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-5 gap-10 items-center">
              ...
              <div className="lg:col-span-2">
                <div className="grid grid-cols-2 gap-4">
                  <motion.img
                    ...
                    transition={{ duration: 0.8 }}
                    viewport={{ once: true }}
                    src="https://picsum.photos/seed/alineadores-a/600/760"
                  ...
                  <motion.img
                    ...
                    viewport={{ once: true }}
                    src="https://picsum.photos/seed/alineadores-b/600/760"
              ...
              >
                ...
                <a
                  href="https://wa.me/526699928700?text=Hola%2C%20quiero%20agendar%20valoraci%C3%B3n%20periodontal"
                  target="_blank"
                  rel="noreferrer"
