...
const navItems = [
  ...
  { 
    ...
    submenu: [
      ...
      { id: "beneficios", label: "Beneficios", href: "/ortodoncia#beneficios" },
      { id: "tratamientos_ortodoncia", label: "Tratamientos", href: "/ortodoncia#tratamientos_ortodoncia" },
      { id: "brackets_metalicos", label: "Brackets Metálicos", href: "/ortodoncia#brackets_metalicos" },
      { id: "brackets_esteticos", label: "Brackets Estéticos", href: "/ortodoncia#brackets_esteticos" },
      { id: "brackets_zafiro", label: "Brackets Zafiro", href: "/ortodoncia#brackets_zafiro" },
      { id: "brackets_porcelana", label: "Brackets Porcelana", href: "/ortodoncia#brackets_porcelana" },
      { id: "aparatologia_ortopedica", label: "Aparatología Ortopédica", href: "/ortodoncia#aparatologia_ortopedica" },
      { id: "especialidades_ortodoncia", label: "Especialidades", href: "/ortodoncia#especialidades_ortodoncia" },
  ...
  { 
    ...
    submenu: [
      ...
      { id: "beneficios", label: "Beneficios", href: "/periodoncia#beneficios" },
      { id: "especialidades_periodoncia", label: "Especialidades", href: "/periodoncia#especialidades_periodoncia" },
  ...
  { 
    ...
    submenu: [
      ...
      { id: "beneficios", label: "Beneficios", href: "/restauradora-avanzada#beneficios" },
      { id: "especialidades_restauradora", label: "Especialidades", href: "/restauradora-avanzada#especialidades_restauradora" },
      { id: "preguntas_restauradora", label: "FAQ", href: "/restauradora-avanzada#preguntas_restauradora" },
      { id: "contacto_restauradora", label: "Contacto", href: "/restauradora-avanzada#contacto_restauradora" }
    ]
  },
      ...
      <header className="fixed top-0 inset-x-0 z-50 backdrop-blur bg-slate-900/95 border-b border-slate-700 shadow-sm">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-24 flex items-center justify-between">
          <div className="flex items-center gap-3">
            {/* Logo */}
            <a href="/">
              <Logo location="header" size="4xl" className="w-40 h-40" />
            </a>
          </div>
            ...
            {navItems.map((item) => (
              <div key={item.id} className="relative group">
                <button
                  ...
                  className={`px-3 py-2 rounded-lg text-sm font-medium transition whitespace-pre-line text-left flex items-center gap-1 ${
                    currentPage === item.id
              ...
              {navItems.map((item) => (
                <div key={item.id}>
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 rounded-lg text-sm font-medium transition whitespace-pre-line flex items-center justify-between ${
                      currentPage === item.id
                        ? "bg-primary-500 text-white"
                        : "hover:bg-slate-800 text-slate-300 hover:text-white"
                    }`}
