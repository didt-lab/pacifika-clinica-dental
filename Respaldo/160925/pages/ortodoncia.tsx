  ...
  return (
    <Layout currentPage="ortodoncia">
      <main>
        ...
        <section className="py-20 bg-gray-50">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                <img src="https://picsum.photos/seed/brackets-metalicos/600/300" alt="Brackets metálicos" className="w-full h-44 object-cover" />
                <div className="p-6">
              ...
              <motion.article
                ...
                className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow"
              >
                <img src="https://picsum.photos/seed/brackets-esteticos/600/300" alt="Brackets estéticos" className="w-full h-44 object-cover" />
                <div className="p-6">
              ...
              <motion.article
                ...
                className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow"
              >
                <img src="https://picsum.photos/seed/brackets-zafiro/600/300" alt="Brackets de zafiro" className="w-full h-44 object-cover" />
                <div className="p-6">
              ...
              <motion.article
                ...
                className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow"
              >
                <img src="https://picsum.photos/seed/brackets-porcelana/600/300" alt="Brackets de porcelana" className="w-full h-44 object-cover" />
                <div className="p-6">
              ...
              >
                <img src="https://picsum.photos/seed/aparatologia-ortopedica/600/300" alt="Aparatología Ortopédica" className="w-full h-44 object-cover" />
                <div className="p-6">
        ...
        {/* Especialidades Ortodoncia Section */}
        <div id="especialidades_ortodoncia" className="absolute -mt-12"></div>
        <section className="py-20 bg-gray-50">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            {/* Header */}
            <motion.div
