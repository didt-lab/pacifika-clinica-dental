...
export default function RestauradoraAvanzada() {
  ...
  const [formData, setFormData] = useState({
    ...
    correo: '',
    telefono: '',
    tratamiento: 'Odontología Restauradora Avanzada',
    mensaje: ''
  });
  ...
  return (
    <Layout currentPage="restauradora-avanzada">
      <main>
        {/* Hero Section */}
        <section id="portada_restauradora" className="relative text-white py-20 overflow-hidden">
        ...
        {/* Especialidades Restauradora Section */}
        <div id="especialidades_restauradora" className="absolute -mt-12"></div>
        <section className="py-20 bg-gray-50">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            {/* Header */}
            <motion.div
        ...
        {/* FAQ Section */}
        <div id="preguntas_restauradora" className="absolute -mt-12"></div>
        <section className="py-20 bg-white">
        ...
        {/* Contact Section */}
        <div id="contacto_restauradora" className="absolute -mt-12"></div>
        <section className="py-20 bg-gray-50">
